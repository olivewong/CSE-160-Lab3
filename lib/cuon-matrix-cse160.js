...
class Vector3 {
    ...
    add(other) {
        ...
        if (typeof other != 'Vector3') {
          throw "add: other must be a Vector3 type";
        }*/
        this.elements.forEach((val, idx) => {
          this.elements[idx] += other.elements[idx];
        });
    ...
    static dot(other1, other2) {
        ...
        other1.elements.forEach((val, idx) => {
          d += other2.elements[idx] * val;
        });
        // Don't delete the return statement.
        return d;
    }
